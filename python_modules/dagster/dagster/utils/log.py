...
def configure_loggers(allow_handler_overrides=False, log_level="INFO"):
    LOGGING_CONFIG = {
        "version": 1,
        ...
        "loggers": {
            "dagster": {
                "handlers": ["default" if not allow_handler_overrides else "null"],
                "level": "INFO",
            },
        },
    }
    ...
    if not allow_handler_overrides:
        logging.getLogger("dagster").handlers[0].formatter.formatTime = _mockable_formatTime
